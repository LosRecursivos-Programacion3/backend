...
import pucp.edu.pe.pucpconnect.domain.Notificacion;
import pucp.edu.pe.pucpconnect.persistence.BaseDAO;
import pucp.edu.pe.pucpconnect.persistence.daoimpl.NotificacionDAOImpl;
...
public class NotificacionWS {
    ...
    public NotificacionWS() {
        ...
        notificacionService = new NotificacionServiceImpl(notificacionDAO);
    }
