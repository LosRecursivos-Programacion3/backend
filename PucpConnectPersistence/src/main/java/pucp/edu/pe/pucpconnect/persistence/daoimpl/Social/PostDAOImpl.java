...
public class PostDAOImpl extends BaseDAOImpl<Post> implements PostDAO {
    ...
    protected PreparedStatement getInsertPS(Connection conn, Post post) throws SQLException {
        ...
        cs.setString(1, post.getNombre());
        cs.setString(2, post.getContenido());
        cs.setTimestamp(3, Timestamp.valueOf(post.getFecha())); // Fecha del post
        cs.setBoolean(4, post.isEstado());
